// app-dashboard-print.js - v1.4（模板字符串改为字符串拼接，统一风格）
        ...
        printWindow.document.write('' +
            ...
            '<head>' +
                ...
                '<style>' +
                    ...
                    '.print-header .logo { font-size: 12pt; font-weight: bold; color: #2563eb; }' +
                    '.print-header .logo img { height: 20px; vertical-align: middle; }' +
                    '.print-store-info { text-align: center; font-size: 8pt; color: #475569; margin: 2px 0; }' +
                    '.print-user-info { text-align: center; font-size: 7pt; color: #64748b; margin-bottom: 3px; }' +
                    ...
                    '.stat-card .stat-value { font-size: 9pt; font-weight: 600; }' +
                    '.stat-card .stat-label { font-size: 6.5pt; }' +
