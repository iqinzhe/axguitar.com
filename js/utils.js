            ...
            <div style="display: grid; grid-template-columns: 1fr 280px; gap: 12px; margin-bottom: 20px;">
                ...
                <div style="background: white; border-radius: 12px; padding: 16px; border: 1px solid #e2e8f0;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 16px;">
                        ${Array(3).fill(`
                            <div>
                                <div style="width: 100%; height: 60px; background: #e2e8f0; border-radius: 8px; animation: skeleton-pulse 1.2s ease-in-out infinite;"></div>
                            </div>
                        `).join('')}
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
                        ${Array(2).fill(`
                            <div style="height: 70px; background: #e2e8f0; border-radius: 8px; animation: skeleton-pulse 1.2s ease-in-out infinite;"></div>
                        `).join('')}
                    </div>
                </div>
                ...
                ${Array(3).fill(`
                    <div style="background: white; border-radius: 12px; padding: 16px; border: 1px solid #e2e8f0;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
                            ${Array(6).fill(`
                                <div style="height: 50px; background: #e2e8f0; border-radius: 8px; animation: skeleton-pulse 1.2s ease-in-out infinite;"></div>
                            `).join('')}
                        </div>
                    </div>
                `).join('')}
