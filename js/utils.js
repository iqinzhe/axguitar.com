...
(function () {
    ...
    function initLanguage() {
        ...
        _translations.id = {
            ...
            'back': 'Kembali',
            'print': 'Cetak',
            'print_order_list': 'Cetak Daftar Pesanan',
            'print_this_order': 'Cetak Pesanan Ini',
            'view': 'Lihat',
        ...
        _translations.zh = {
            ...
            'back': '返回',
            'print': '打印',
            'print_order_list': '打印订单列表',
            'print_this_order': '打印本订单',
            'view': '查看',
            'view_detail': '查看详细',
            'search': '搜索',
            'export': '导出',
 ...
 * @param {string} options.subtitle - 副标题如统计期间（可选）
 * @param {boolean} options.showStore - 是否显示门店信息（默认 true）
 * @returns {Object} { headHtml, footHtml, style }
 */
Utils.getPrintHeaderFooter = function(options = {}) {
