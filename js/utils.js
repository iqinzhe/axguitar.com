const Utils = {
    ...
    translations: {
        id: {
            ...
            financial_report: "Laporan Keuangan", user_management: "Manajemen Pengguna",
        ...
        zh: {
            ...
            financial_report: "财务报表", user_management: "用户管理", backup_restore: "备份恢复",
            total_orders: "总订单数", active: "进行中", completed: "已结清", liquidated: "已变卖",
