...
// 管理费费率：当金 > 3,000,000 时按 1% 收取
Utils.ADMIN_FEE_RATE = 0.01; // 1%
...
Rp 500,000 < 金额 ≤ Rp 3,000,000	Rp 30,000 按此调整
好的，我来按照您的要求调整管理费的第二档金额。

修改内容
管理费计算标准（最终版）
当金金额	管理费
≤ Rp 500,000	Rp 20,000
Rp 500,000 < 金额 ≤ Rp 3,000,000	Rp 30,000
> Rp 3,000,000	按 1% 收取，上不封顶
只需要修改 utils.js 中的 calculateAdminFee 函数：
...
| Rp 500,000 < 金额 ≤ 3,000,000 | Rp 30,000 |
...
默认当金金额的2%，下拉选项有：0, 1%, 2%, 3%, 4%, 5%

@param {number} loanAmount - 当金金额

@param {number} percent - 服务费百分比（可选，默认2）

@returns {Object} { percent, amount }
*/
