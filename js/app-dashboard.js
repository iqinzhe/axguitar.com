// app-dashboard.js - 仪表板、登录、路由、报表模块
            ...
            if (isAdmin) {
                ...
                document.getElementById("app").innerHTML = `
                    ...
                    <div class="card" style="border:2px solid #3b82f6;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); border: 1px solid #cbd5e1; border-radius: 8px; overflow: hidden;">
                            <div class="stat-card" style="border-right: 1px solid #cbd5e1; border-bottom: 1px solid #cbd5e1; margin:0; border-radius:0;">
                            ...
                            <div class="stat-card" style="border-bottom: 1px solid #cbd5e1; margin:0; border-radius:0;">
                                <div class="stat-value">${Utils.formatCurrency(grandTotal.loan)}</div>
                                <div>${t('total_loan')}</div>
                            </div>
                            <div class="stat-card" style="border-right: 1px solid #cbd5e1; margin:0; border-radius:0;">
                ...
                <div class="card">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group"><label>${lang === 'id' ? 'Peran' : '角色'} *</label>
                            <select id="newRole"><option value="store_manager">${lang === 'id' ? 'Manajer Toko' : '店长'}</option><option value="admin">${lang === 'id' ? 'Administrator' : '管理员'}</option></select>
                        </div>
        ...
        try {
            ...
            if (expenses && expenses.length > 0) {
                for (var e of expenses) {
                    ...
                    var actionBtns = '';
                    if (canEdit) {
                        actionBtns = `<button onclick="APP.editExpense('${e.id}')" style="padding:4px 8px;font-size:12px;">✏️ ${t('edit')}</button>
                    ...
                    rows += `<tr>
                        ...
                        <td style="border:1px solid #cbd5e1;padding:8px;">${methodText}</td>
            ...
            document.getElementById("app").innerHTML = `
                ...
                <div class="card"><h3>${lang === 'id' ? 'Total Pengeluaran' : '支出总额'}: <span style="color:#ef4444;">${Utils.formatCurrency(totalAmount)}</span></h3></div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group"><label>${lang === 'id' ? 'Jumlah' : '金额'} *</label><input type="text" id="expenseAmount" placeholder="0" style="text-align:right;"></div>
    ...
    showPaymentHistory: async function() {
        ...
        try {
            ...
            var rows = allPayments.length === 0
                ? `<tr><td colspan="9" style="text-align:center;padding:20px;">${Utils.t('no_data')}</td></tr>`
    ...
    viewOrder: async function(orderId) {
        ...
        try {
            ...
            if (payments && payments.length > 0) {
                ...
                payRows = `<tr><td colspan="6" style="text-align:center;padding:20px;">${t('no_data')}</td></tr>`;
            }
